    ...
    while(1) {
        ...
        *(screen + 6) = key[1];
        ...
        if(uart_get(&tmp[0]) == 0) {
            ...
            {
            case '1':
                    uart_print("port_0x7ffd = 0x08\r\n");
                    port_0x7ffd = 0x08;
                break;
            case '2':
                    uart_print("port_0x7ffd = 0x00\r\n");
                    port_0x7ffd = 0x00;
                break;  
            case '3':
                    init_screen();
            ...
            case '4':
                    ...
                    for(unsigned int r = 0x4000; r < 0xffff; r++) {
                        *(char*)r = (char)0x00;
                    }
                    uart_print("port_0xeff7 = 0x00\r\n");
                    port_0xeff7 = 0x00;
...
void check_mem(void) {
    ...
    *(char*)0x3fff = 0x55;
    ...
    uart_print("write @ 0x4000 0x55\r\n");
    *(char*)0x4000 = 0x55;
    uart_print("read @ 0x4000");
    if(*(char*)0x4000 == 0x55) uart_print(" OK\r\n");
    else uart_print(" FAIL\r\n");
    uart_print("\r\n");

    uart_print("write @ 0x4001 0x55\r\n");
    *(char*)0x4001 = 0x55;
    uart_print("read @ 0x4001");
    if(*(char*)0x4001 == 0x55) uart_print(" OK\r\n");
    else uart_print(" FAIL\r\n");
    uart_print("\r\n");
    ...
    *(char*)0x8000 = 0x55;
    ...
    uart_print("write @ 0x8001 0x55\r\n");
    *(char*)0x8001 = 0x55;
    uart_print("read @ 0x8001");
    if(*(char*)0x8001 == 0x55) uart_print(" OK\r\n");
    else uart_print(" FAIL\r\n");
    uart_print("\r\n");


    uart_print("write @ 0xc000 0x55\r\n");
    *(char*)0xc000 = 0x55;
    uart_print("read @ 0xc000");
    if(*(char*)0xc000 == 0x55) uart_print(" OK\r\n");
    else uart_print(" FAIL\r\n");
    uart_print("\r\n");


    uart_print("write @ 0xc001 0x55\r\n");
    *(char*)0xc001 = 0x55;
    uart_print("read @ 0xc001");
    if(*(char*)0xc001 == 0x55) uart_print(" OK\r\n");
    else uart_print(" FAIL\r\n");
    uart_print("\r\n");

    // for(unsigned int r = 0x400A; r < 0xffff; r++) {
    //     *(char*)r = (char)r;
